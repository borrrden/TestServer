...
namespace Couchbase.Lite.Testing
{
    public static class MemoryMap
    {
        ...
        [NotNull]
        private static readonly ConcurrentDictionary<long, object> Map = new ConcurrentDictionary<long, object>();
        ...
        public static long New<T>(params object[] args)
        {
        ...
        public static long Store(object obj)
        {
